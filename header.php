...
<div class="container">
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$fastfundmortgage_description = get_bloginfo( 'description', 'display' );
			if ( $fastfundmortgage_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $fastfundmortgage_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
